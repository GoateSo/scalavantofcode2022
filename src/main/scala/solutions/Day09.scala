...
class Day09(input: Seq[String], isSample: Boolean)
  ...
  def simulate(n: Int): Int =
    ...
    inputs
      ...
      ._2
      .size // return the size of the visited set
